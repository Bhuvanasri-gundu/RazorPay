...
### Razorpay Test Gateway Recovery Flow
![Razorpay Test Gateway](docs/screenshots/razorpay-test-gateway.png)
Dynamic payment recovery links generated by REVA direct customers to the integrated Razorpay test checkout portal, allowing customers to complete payment via alternative methods (Credit/Debit, Netbanking, or UPI).
