...
When a customer clicks to complete payment, the official Razorpay Standard Checkout SDK launches in sandbox test mode, displaying price summary (₹4,999), prefilled contact details, available payment options (Cards, Netbanking, UPI), and the red Test Mode indicator.
